...
In this project, I learnt about importing modules, using their attributes, and
also creating modules in Python. Furthermore, I learned the use of the Python
dir() function and the argv attribute in the sys module to access command line
arguments.
