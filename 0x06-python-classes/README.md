...
In this project, I started learning object-oriented programming(OOP) paradigm
using classes and objects also referred to as instances in Python. I learnt
about the principles of OOP which are Encapsulation, Data Abstraction,Polymorphi-
sm and Inheritance. I also learnt about attributes (public, protected and private),
...
* **10. ByteCode -> Python #5**
  * [103-magic_class.py](./103-magic_class.py): Python function matching exactly a bytecode provided for the task.